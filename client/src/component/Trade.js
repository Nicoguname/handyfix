    ...
    return (
      <div className="trade">
        ...
        <div className="trade__image--slide">
          {/* <div className="trade__image--fade"> 1 / 2</div> */}
            <img className="trade__image1" src={ImageHero1} alt="hero" />
        </div>
        ...
        <Link to="/form1"><div className="trade__icon--1">
        ...
        <Link to="/form1">  <div className="trade__icon--2">
        ...
        <Link to="/form1">  <div className="trade__icon--3">
        ...
        <Link to="/form1"> <div className="trade__icon--4">
        ...
        <Link to="/form1">  <div className="trade__icon--5">
        ...
        <Link to="/form1">  <div className="trade__icon--6">

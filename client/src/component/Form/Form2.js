      ...
      <div className="form2">
        <form onSubmit={this.handleSubmit2}>
          <div className="form2__image">
            ...
            <div className="form2__image--title">
              <label>Review Service</label>
            </div>
            <img
              className="form2__image--flyer"
              src={Smileys}
              alt="mobilephone"
            />
          </div>
          <div className="form2__border">
            <div className="form2__name">
              <label className="form2__name1" htmlFor="artisan name">
                Artisan Name:
              </label>
            ...
            <div className="form2__service">
              <label className="form2__service1" htmlFor="service type">
                Service Type:
              </label>
            ...
            <div className="form2__comm">
              <label className="form2__comm1" htmlFor="comments">
                Comments:
              </label>
              <textarea
                className="form2__comm2"
            ...
            <div className="form2__rating">
              <label className="form2__rating1" htmlFor="rating">
                Rating:
              </label>
              <select
                className="form2__rating2"
                value={rating}
            ...
            <div className="form2__name3">
              <label className="form2__name4" htmlFor="reviewer name">
                Review by:
              </label>
              <input
                className="form2__name5"
                type="text"
            ...
            <div className="form2__date">
              <label className="form2__date1" htmlFor="review date">
                Review Date:
              </label>
              <div className="form2__date2" value={reviewdate} />
            </div>
            <button className="form2__submit" value="submit">
              Submit
            </button>
          </div>
        </form>
